...
<div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Products</a><a href="#">Edit Products</a> </div>
      <h1>Products</h1>
          ...
          <div class="widget-box">
            ...
            <form enctype = "multipart/form-data" class="form-horizontal" method="post" action="{{url('/admin/edit-product/'.$productdetails->id)}}" name="edit_product" id="edit_product" novalidate="novalidate">
                ...
                <div class="control-group">
                  ...
                  <div class="control-group">
                    <label class="control-label">Feature Iitem</label>
                    <div class="controls">

...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
      <li <?php if (preg_match('/dashboard/i', $url)){ ?> class="active" <?php } ?>>
          <a href="{{url('admin/dashboard')}}"><i class="icon-dashboard"></i> <span>Dashboard</span></a> 
      </li>
      ...
      <li class="submenu"> <a href="#"><i class="fa fa-product-hunt"></i> <span>Products</span> <span class="label label-important">2</span></a>
      ...
      <li class="submenu"> <a href="#"><i class="fa fa-window-minimize"></i> <span>Coupons</span> <span class="label label-important">2</span></a>
      ...
      <li class="submenu"> <a href="#"><i class="fa fa-bars"></i> <span>Orders</span> <span class="label label-important">1</span></a>
      ...
      <li class="submenu"> <a href="#"><i class="fa fa-sliders"></i> <span>Banners</span> <span class="label label-important">2</span></a>
      ...
      <li class="submenu"> <a href="#"><i class="fa fa-users"></i> <span>Users</span> <span class="label label-important">1</span></a>
      ...
      <li class="submenu"> <a href="#"><i class="fa fa-product-hunt"></i> <span>CMS Pages</span> <span class="label label-important">2</span></a>
